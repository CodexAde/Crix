          ...
          <div className="relative overflow-hidden transition-all duration-500 ">
            ...
            <div className="prose prose-sm md:prose-base max-w-none break-words leading-loose text-primary relative z-10">
              <ReactMarkdown
                ...
                components={{
                  h1: ({ node, ...props }) => <h1 className="block text-2xl md:text-3xl font-black mb-6 mt-8 text-primary tracking-tight bg-gradient-to-r from-primary to-accent bg-clip-text" style={{ display: 'block' }} {...props} />,
                  h2: ({ node, ...props }) => <h2 className="block text-xl md:text-2xl font-bold mb-5 mt-10 text-accent tracking-tight flex items-center gap-3" style={{ display: 'flex' }} {...props} />,
                  h3: ({ node, ...props }) => <h3 className="block text-lg md:text-xl font-semibold mb-4 mt-8 text-primary/90 tracking-tight" style={{ display: 'block' }} {...props} />,
                  p: ({ node, ...props }) => <p className="mb-5 last:mb-0 text-sm md:text-base leading-[1.9] text-secondary/90 font-medium" {...props} />,
                  ul: ({ node, ...props }) => <ul className="list-none space-y-3 text-sm md:text-base text-secondary/90 mb-6 ml-2" {...props} />,
                  ol: ({ node, ...props }) => <ol className="list-decimal list-outside ml-6 mb-6 space-y-3 text-sm md:text-base text-secondary/90" {...props} />,
                  li: ({ node, ...props }) => <li className="leading-relaxed pl-3 hover:text-primary transition-colors relative before:content-[''] before:absolute before:left-0 before:top-[0.6em] before:w-1.5 before:h-1.5 before:rounded-full before:bg-accent/50" {...props} />,
                  hr: ({ node, ...props }) => (
                  ...
                  blockquote: ({ node, ...props }) => (
                    <div className="my-8 relative">
                      <div className="absolute inset-0 bg-gradient-to-r from-accent/20 to-transparent rounded-2xl blur-xl opacity-30" />
                      <blockquote className="relative bg-white/[0.03] backdrop-blur-sm border-l-4 border-accent rounded-r-2xl p-6 pl-6 text-sm md:text-base text-secondary/90 leading-relaxed italic shadow-lg shadow-accent/5" {...props} />
                    </div>
                  ),
