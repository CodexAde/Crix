...
import { Download, ChevronRight, X, Sparkles } from 'lucide-react';
    ...
    <div className="min-h-screen bg-black flex flex-col items-center justify-center p-6 relative overflow-hidden">
        ...
        >
            ...
            {deferredPrompt ? (
                ...
                <div className="bg-white/5 border border-white/10 rounded-2xl p-4 mb-6 w-full text-left">
                    ...
                    <p className="text-xs text-gray-400 mb-3">
                        {isIOS 
                            ...
                            : "Click the install icon in your browser address bar/menu."}
                    </p>
                    {isIOS && (
