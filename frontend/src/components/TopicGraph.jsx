...
export default function TopicGraph({ topics, onSelectTopic }) {
  ...
  return (
    <div className="relative py-10 px-4 max-w-2xl mx-auto">
       <div className="absolute left-8 top-0 bottom-0 w-1 bg-border-soft rounded-full" />
               ...
               return (
                   <div key={topic._id} className="relative flex items-center group">
                       <button 
                            ...
                            className={clsx(
                                "z-10 w-16 h-16 rounded-full border-4 flex items-center justify-center transition-all bg-card shadow-soft",
                       ...
                       <div className={clsx(
                           ...
                           status === 'completed' ? 'bg-green-500/20' : 'bg-border-soft'
                       )} />
                       ...
                       <motion.div 
                            ...
                            className={clsx(
                                ...
                                status === 'doubts' ? "bg-red-500/10 border-red-400/30" : "bg-card border-border-soft shadow-soft",
                            )}
                       >
